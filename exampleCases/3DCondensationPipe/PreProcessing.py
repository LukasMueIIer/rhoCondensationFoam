...
def PreProcessing(dir_path, coreCount):    
    ...
    x_chop = 200     #chopping amount in x-direction
    y_chop = 20       #chopping amount in y direction of the inlet 
    exp_Inlet = 1.05
    exp_Farfield = 1.05
    x_decay = 1.01

    coax_jet.full_rotational_mesh(dir_path,ri,ra,l,pipe_lengt,alpha,x_chop,y_chop,exp_Inlet,exp_Farfield,x_decay)   #running classy blocks with modified mesh
    ...
    par_u_file["boundaryField"]["inlet"]["type"] = "fixedValue"
    par_u_file["boundaryField"]["inlet"]["value"] = "uniform (%f 0 0)" %(U9)
 
    par_u_file["boundaryField"]["FarField"]["type"] = "inletOutlet"
    par_u_file["boundaryField"]["FarField"]["inletValue"] = "uniform (%f 0 0)" %(U0)
    par_u_file["boundaryField"]["FarField"]["value"] = "uniform (%f 0 0)" %(U0)
    ...
    par_p_file["boundaryField"]["inlet"]["type"] = "zeroGradient"

    par_p_file["boundaryField"]["FarField"]["type"] = "outletInlet"
    par_p_file["boundaryField"]["FarField"]["outletValue"] = "uniform %f" %(p0)
    par_p_file["boundaryField"]["FarField"]["value"] = "uniform %f" %(p0)
    ...
    par_T_file["boundaryField"]["inlet"]["type"] = "fixedValue"
    par_T_file["boundaryField"]["inlet"]["value"] = "uniform %f" %(T9)


    par_T_file["boundaryField"]["FarField"]["type"] = "inletOutlet"
    par_T_file["boundaryField"]["FarField"]["inletValue"] = "uniform %f" %(T0)
    par_T_file["boundaryField"]["FarField"]["value"] = "uniform %f" %(T0)
    ...
    par_k_file["boundaryField"]["inlet"]["type"] = "turbulentIntensityKineticEnergyInlet"
    par_k_file["boundaryField"]["inlet"]["intensity"] = "%f" %(I)
    par_k_file["boundaryField"]["inlet"]["value"] = "uniform %f" %(k9)


    par_k_file["boundaryField"]["FarField"]["type"] = "inletOutlet"
    par_k_file["boundaryField"]["FarField"]["inletValue"] = "uniform %f" %(k0)
    par_k_file["boundaryField"]["FarField"]["value"] = "uniform %f" %(k0)
    ...
    par_e_file["boundaryField"]["inlet"]["type"] = "fixedValue"
    par_e_file["boundaryField"]["inlet"]["value"] = "uniform %f" %(epsilon9)

    par_e_file["boundaryField"]["FarField"]["type"] = "inletOutlet"
    par_e_file["boundaryField"]["FarField"]["inletValue"] = "uniform %f" %(epsilon0)
    par_e_file["boundaryField"]["FarField"]["value"] = "uniform %f" %(epsilon0)
    ...
    par_R_file["boundaryField"]["inlet"]["type"] = "fixedValue"
    par_R_file["boundaryField"]["inlet"]["value"] = "uniform (%f 0 0 %f 0 %f )" %(k9, k9 / 2, k9 / 2)

    par_R_file["boundaryField"]["FarField"]["type"] = "inletOutlet"
    par_R_file["boundaryField"]["FarField"]["inletValue"] = "uniform (%f 0 0 %f 0 %f )" %(k0, k0 / 2, k0 / 2)
    par_R_file["boundaryField"]["FarField"]["value"] = "uniform (%f 0 0 %f 0 %f )" %(k0, k0 / 2, k0 / 2)
    ...
    par_w_file["boundaryField"]["inlet"]["type"] = "fixedValue"
    par_w_file["boundaryField"]["inlet"]["value"] = "uniform %f" %w_9

    par_w_file["boundaryField"]["FarField"]["type"] = "inletOutlet"
    par_w_file["boundaryField"]["FarField"]["inletValue"] = "uniform %f" %w_0
    par_w_file["boundaryField"]["FarField"]["value"] = "uniform %f" %w_0
